              ...
              <div className="flex justify-start">
                ...
                <div className="flex-col">
                  <label className="flex flex-row">
                    <span className="block text-sm font-medium  text-gray-900 pt-4 pr-2.5">
                      Trailer:
                    </span>
                    <input
                  ...
                  <button
                    type="submit"
                    className="rounded-sm px-6 pt-2.5 pb-2 text-sm font-medium  m-1 bg-[#E50914] text-white bold-2 shadow-xl  drop-shadow-xl ml-72"
                  >
                    Next
                  </button>
                </div>
