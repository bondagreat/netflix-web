      ...
      <div className="w-screen h-screen fixed top-0 left-0 bg-black/50">
        <div className="w-full h-full flex justify-center items-center">
          <div>
            ...
            <div className="p-8 rounded-lg shadow-lg bg-white w-[700] h-[511] ">
              <form>
                <div className="flex justify-start">
                  ...
                  <div className="flex-col">
                    ...
                    <button
                      ...
                      className="rounded-md px-6 pt-2.5 pb-2 text-xl font-medium  mt-10 bg-[#E50914] text-white bold-2 shadow-xl  drop-shadow-xl ml-72"
                    >
                      Next
                    </button>
                  </div>
